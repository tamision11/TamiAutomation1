@owner=tami_sion
@tmsLink=talktala.atlassian.net/browse/AUTOMATION-3053
Feature: QM - B2B - Manual BH
  ...
  Rule: Therapy
    ...
    Scenario: Flow 131 - Anthem - Therapy
      ...
      Then Plan details for the first room are
        | plan name                                     | Anthem Unlimited Sessions Messaging or Live Session |
  ...
  Rule: Couples therapy
    ...
    Scenario: Flow 131 - Anthem - Couples therapy
      And Click on secure your match button
      And Create account for primary user with
        | password | STRONG |
        | nickname | VALID  |
      ...
      And Navigate to payment and plan URL
      Then Plan details for the first room are
        | plan name                           | Anthem BH Couples Messaging or Live v2 |
        | credit description                  | credit amount                          |
  ...
  Rule: Psychiatry
    ...
    Scenario: Flow 131 - Anthem - Psychiatry
      And Click on secure your match button
      And Create account for primary user with
        | password | STRONG |
        | nickname | VALID  |
      ...
      And Navigate to payment and plan URL
      Then Plan details for the first room are
        | plan name                                        | Anthem BH 30 sessions psychiatry |
        | credit description                               | credit amount                    |
