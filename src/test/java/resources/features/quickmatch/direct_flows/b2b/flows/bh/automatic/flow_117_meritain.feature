@owner=nir_tal
@tmsLink=talktala.atlassian.net/browse/AUTOMATION-2822
Feature: QM - B2B - Automatic BH

  Background:
    Given Navigate to flow117
  ...
  Rule: Therapy
    ...
    Scenario: Flow 117 - Meritain - Therapy
      ...
      Then Plan details for the first room are
        | plan name | Meritain BH Unlimited Sessions Messaging or Live Session |
  ...
  Rule: Psychiatry
    ...
    Scenario: Flow 117 - Meritain - Psychiatry
      And Click on secure your match button
      ...
      And Navigate to payment and plan URL
      Then Plan details for the first room are
        | plan name | Meritain BH Psychiatry |
      And Payment and Plan - Waiting to be matched text is displayed for the first room