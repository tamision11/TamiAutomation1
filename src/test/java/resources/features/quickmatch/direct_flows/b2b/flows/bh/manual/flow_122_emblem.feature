@owner=nir_tal
@tmsLink=talktala.atlassian.net/browse/AUTOMATION-2865
Feature: QM - B2B - Manual BH

  Background:
    Given Navigate to flow122
  ...
  Rule: Therapy
    ...
    Scenario: Flow 122 - Emblem - Therapy
      ...
      Then Plan details for the first room are
        | plan name                                     | Emblem Health Unlimited Sessions Messaging or Live Session |
  ...
  Rule: Psychiatry
    ...
    Scenario: Flow 122 - Emblem - Psychiatry
      And Click on secure your match button
      And Create account for primary user with
        | password | STRONG |
        | nickname | VALID  |
      ...
      And Navigate to payment and plan URL
      Then Plan details for the first room are
        | plan name                              | Emblem Health BH 30 sessions psychiatry |
        | credit description                     | credit amount                           |
  ...
  Rule: Couples therapy
    ...
    Scenario: Flow 122 - Emblem - Couples therapy
      And Click on secure your match button
      And Create account for primary user with
        | password | STRONG |
        | nickname | VALID  |
      ...
      And Navigate to payment and plan URL
      Then Plan details for the first room are
        | plan name                           | Emblem Health BH Couples Messaging or Live Sessions |
        | credit description                  | credit amount                                       |
