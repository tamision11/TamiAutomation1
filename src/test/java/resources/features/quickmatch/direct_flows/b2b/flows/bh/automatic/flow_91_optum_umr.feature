@tmsLink=talktala.atlassian.net/browse/AUTOMATION-2618
Feature: QM - B2B - Automatic BH
  Leads to flow 7

  Background:
    Given Navigate to flow91
  ...
  Rule: Therapy
    ...
    Scenario: Flow 91 - Optum UMR - Therapy
      ...
      Then Plan details for the first room are
        | plan name | UMR BH Unlimited Sessions Messaging or Live Session |
  ...
  Rule: Psychiatry
    ...
    Scenario: Flow 91 - Optum UMR - Psychiatry
      And Click on secure your match button
