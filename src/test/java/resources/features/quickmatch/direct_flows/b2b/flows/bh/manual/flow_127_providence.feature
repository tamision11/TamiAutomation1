@owner=tami_sion
@tmsLink=talktala.atlassian.net/browse/PLATFORM-2991
Feature: QM - B2B - Manual BH

  Background:
    Given Navigate to flow127
  ...
  Rule: Therapy
    ...
    Scenario: Flow 127 - Providence - Therapy
      ...
      Then Plan details for the first room are
        | plan name                                     | Providence Unlimited Sessions Messaging or Live Session |
  ...
  Rule: Psychiatry
    ...
    Scenario: Flow 127 - Providence - Psychiatry
      And Click on secure your match button
      And Create account for primary user with
        | password | STRONG |
        | nickname | VALID  |
      ...
      And Navigate to payment and plan URL
      Then Plan details for the first room are
        | plan name                              | Providence BH 30 sessions psychiatry |
        | credit description                     | credit amount                        |
