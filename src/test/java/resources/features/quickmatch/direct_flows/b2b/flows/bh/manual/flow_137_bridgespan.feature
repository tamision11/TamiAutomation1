Feature: QM - B2B - Manual BH
  ...
  Rule: Therapy
    ...
    Scenario: Flow 137 - Bridgespan - Therapy
      ...
      Then Plan details for the first room are
        | plan name                                     | Bridgespan Unlimited Sessions Messaging or Live Session |
  ...
  Rule: Couples therapy
    ...
    Scenario: Flow 137 - Bridgespan - Couples therapy
      And Click on secure your match button
      And Create account for primary user with
        | password | STRONG |
        | nickname | VALID  |
      ...
      And Navigate to payment and plan URL
      Then Plan details for the first room are
        | plan name                           | Bridgespan BH Couples Messaging or Live v2 |
        | credit description                  | credit amount                              |
  ...
  Rule: Psychiatry
    ...
    Scenario: Flow 137 - Bridgespan - Psychiatry
      And Click on secure your match button
      And Create account for primary user with
        | password | STRONG |
        | nickname | VALID  |
      ...
      And Navigate to payment and plan URL
      Then Plan details for the first room are
        | plan name                                        | Bridgespan BH 30 sessions psychiatry |
        | credit description                               | credit amount                        |
