Feature: QM - B2B - Manual BH
  ...
  Rule: Therapy
    ...
    Scenario: Flow 43 - Optum - Therapy
      ...
      Then Plan details for the first room are
        | plan name                                     | Optum BH Unlimited Sessions Messaging or Live Session v2 |
  ...
  Rule: Psychiatry
    ...
    Scenario: Flow 43 - Optum - Psychiatry
      And Click on secure your match button
      And Create account for primary user with
        | password | STRONG |
        | nickname | VALID  |
      ...
      And Navigate to payment and plan URL
      Then Plan details for the first room are
        | plan name                                        | Optum BH Psychiatry v2 |
        | credit description                               | credit amount          |
  ...
  Rule: Couples therapy
    ...
    Scenario: Flow 43 - Optum - Couples therapy
      And Click on secure your match button
      And Create account for primary user with
        | password | STRONG |
        | nickname | VALID  |
      ...
      And Navigate to payment and plan URL
      Then Plan details for the first room are
        | plan name                           | Optum BH Couples Messaging or Live v2 |
        | credit description                  | credit amount                         |
