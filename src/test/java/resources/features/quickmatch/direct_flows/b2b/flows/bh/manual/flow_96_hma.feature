...
Feature: QM - B2B - Manual BH
  ...
  Rule: Therapy
    ...
    Scenario: Flow 96 - HMA - Therapy
      ...
      Then Plan details for the first room are
        | plan name                                     | HMA BH Unlimited Sessions Messaging or Live Session v2 |
  ...
  Rule: Couples therapy
    ...
    Scenario: Flow 96 - HMA - Couples therapy
      And Click on secure your match button
      And Create account for primary user with
        | password | STRONG |
        | nickname | VALID  |
      ...
      And Navigate to payment and plan URL
      Then Plan details for the first room are
        | plan name                           | HMA BH Couples Messaging or Live v2 |
        | credit description                  | credit amount                       |
  ...
  Rule: Psychiatry
    ...
    Scenario: Flow 96 - HMA - Psychiatry
      And Click on secure your match button
      And Create account for primary user with
        | password | STRONG |
        | nickname | VALID  |
      ...
      And Navigate to payment and plan URL
      Then Plan details for the first room are
        | plan name                                        | HMA BH Psychiatry v2 |
        | credit description                               | credit amount        |
